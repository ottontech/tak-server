...
The key improvements are:
 ...
 - Updates PostgreSQL 10 to PostgreSQL 15.
...
| ------------------------------------- | ----------- | ---------------------------------- | ------------------------------------------------------------------ |
| `takserver-docker-5.0-RELEASE-34.zip` | `689963008` | `62b816132c7e94f84e2ec6e530911132` | `B88EED7E0ACF913991053A6BDD881DA74779E776026739805F1E746086D9EA6F` |
